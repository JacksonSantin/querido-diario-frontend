...
export const HELP = {
  ...
  text: 'A comunidade de pessoas envolvidas no Querido Diário é muito \n receptiva, temos um \n<a href="[removido]" target="_blank">canal no Discord</a> onde utilizamos para fazer conversas por texto e voz, entre e se apresente! Por lá organizamos para fazer nossa reunião pública e mensal com as pessoas que mantêm o projeto. \nCaso tenha alguma dúvida sobre o projeto e a nossa comunidade vocêtambém pode nos mandar um email pelo seguinte endereço: <a href="mailto:[removido]">[removido]</a>.',
};
